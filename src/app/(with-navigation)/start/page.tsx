  ...
  return (
    <div className="px-3 pb-[120px] pt-12 md:px-8 lg:px-20 lg:pt-20">
      ...
      <div className="mt-14 grid grid-flow-row gap-3">
        ...
        <div className="bg-white-3 mb-6 flex flex-col gap-5 rounded-28 border border-white-8 p-3 pt-5">
          <Image
      ...
      <div className="flex flex-col gap-3 lg:flex-row">
        <div className="bg-white-3 flex flex-1 flex-col rounded-28 border border-white-8 p-6 pt-5">
