...
const FeaturesDisclaimer = () => {
  return (
    <div className="w-full pt-8 @container/main lg:pt-20">
      <div className="flex flex-col items-start justify-center gap-2 rounded-16 border border-dashed border-white-12 bg-white-3 px-4 py-[14px] @[519px]/main:flex-row @[519px]/main:items-center">
