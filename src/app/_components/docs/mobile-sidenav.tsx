...
const MobileSidenav = ({ items, title, ctaLabel = 'Browse' }: Props) => {
  const [open, setOpen] = useState(false)

  return (
    <div className="bg-dark-100/80 sticky top-[84px] z-20 border-b border-white-12 backdrop-blur-xl lg:hidden">
      <div className="flex items-center justify-between px-4 py-3">
        <div className="text-16 font-500 text-white-95">{title}</div>
