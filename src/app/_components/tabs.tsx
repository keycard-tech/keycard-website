...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cx(
      'inline-flex h-12 items-center justify-center gap-1 rounded-16 border border-white-12 bg-white-4 p-1 text-white-95 backdrop-blur-[20px]',
      className,
    )}
    {...props}
  />
