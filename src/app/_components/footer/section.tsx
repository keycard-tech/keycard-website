...
const Section = (props: Props) => {
  ...
  return (
    <div className="relative flex flex-col gap-6 border-b border-dashed border-white-20 p-6 lg:border-0 lg:pb-12 lg:pt-0 [&:nth-child(2)]:pt-0 lg:[&:nth-child(2)]:col-start-2">
