...
Keycard ships with all applets fully installed but not initialized. The most convenient way to initialize and manage the card is with [Status apps](https://status.app/apps) (mobile or desktop). 
