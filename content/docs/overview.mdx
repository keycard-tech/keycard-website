...
It’s natively integrated with all [Status apps](https://status.app) and works on iOS/Android mobile phones and desktops with a USB smartcard reader. Learn more about keycard [here](https://keycard.tech/keycard).
