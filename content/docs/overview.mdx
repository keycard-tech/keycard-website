...
It’s natively integrated with all [Status apps](https://status.app), and compatible with Android phones and USB smartcard readers. [Learn more](https://keycard.tech/keycard).
