...
<Table>
    ...
    <TableContent>
        <TableRow>
            <TableCell>Authentikey public key, compressed</TableCell>
            <TableCell>33 bytes</TableCell>
        </TableRow>
        <TableRow>
            <TableCell>CA signature `r`</TableCell>
            <TableCell>32 bytes</TableCell>
        </TableRow>
        <TableRow>
            <TableCell>CA signature `s`</TableCell>
            <TableCell>32 bytes</TableCell>
        </TableRow>
        <TableRow>
            <TableCell>Recovery id `v`</TableCell>
