...
After a successful VERIFY PIN, subsequent key derivation, export, and signing commands operate on the wallet view associated with the verified PIN (regular or duress).
