...
Hardware design files are open source and include 
- electronic bill of material 
- electronic schematics 
- electronic layout 
- mechanical bill of material 
- full 3D defintion of mechanical parts 

These files are live in the Keycard Shell [repo](https://github.com/keycard-tech/keycard-shell/tree/master/hardware)